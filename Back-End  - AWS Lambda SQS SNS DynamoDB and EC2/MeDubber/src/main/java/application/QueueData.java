...
public class QueueData {
	...
	public static MessageAttributeValue getGetContactAttributeValue() {
		return new MessageAttributeValue().withDataType("String").withStringValue(QueueData.Tasks.GetContactTask.getName());
	}
	
	public static MessageAttributeValue getNewNicknameAttributeValue() {
		return new MessageAttributeValue().withDataType("String").withStringValue(QueueData.Tasks.NewNickNameTask.getName());
	}
	
	public static MessageAttributeValue getNicknamesAttributeValue() {
		return new MessageAttributeValue().withStringListValues(QueueData.Tasks.GetNicknames.getName());
	}
